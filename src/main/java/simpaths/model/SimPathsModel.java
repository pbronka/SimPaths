...
//	private boolean useSBAMMatching = false;
	...
	public void buildObjects() {
		...
		if (!shockPropagation) {
			...
			if (wageShock) includedColumns.addAll(Arrays.asList("id_Person", "idBenefitUnit", "dag", "dhe", "region", "deh_c3", "les_c4", "dlltsd", "n_children_allAges", "ded", "dehm_c3", "dehf_c3", "dcpst", "hoursWorkedWeekly"));
